...
const TOOLS: ToolDef[] = [
  ...
  { id: 'schedule', icon: IconCalendar, label: 'My Day', href: '/schedule', gradient: 'from-teal-400 to-cyan-600', stars: 0 },
  { id: 'stories', icon: IconBook, label: 'Stories', href: '/stories', gradient: 'from-violet-400 to-purple-600', stars: 0 },
